...
export default function PromoteEvent() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    vipTickets: 0, // Number of VIP tickets
    regularTickets: 0, // Number of Regular tickets
  });

  const [reviewing, setReviewing] = useState(false); // State for review mode
  ...
  const handleSubmit = (e) => {
    ...
    setReviewing(true); // Set to review mode after form submission
  };

  const handleConfirmReview = () => {
    setSubmitted(true);
    window.location.href = "/payment";  // Navigate to payment page after confirmation
  };
      ...
      {!reviewing ? (
        ...
        <div className="mt-12 p-6 bg-gray-50 rounded-lg shadow-inner">
          ...
          <div className="w-full flex justify-center mt-4">
            <button onClick={handleConfirmReview} className="bg-[#128f8b] text-white font-semibold py-3 rounded transition">
