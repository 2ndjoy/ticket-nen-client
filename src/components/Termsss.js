        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <section className="lg:col-span-8 xl:col-span-9 space-y-6">
            ...
            <div id="sec-14" className="rounded-2xl border bg-white/80 backdrop-blur-xl p-6 shadow-sm">
              ...
              <p className="text-gray-700">
                <span className="font-semibold">[Ticket Nen BD]</span>
                <br />
                
                
                 Location: Tilagor Point, Sylhet, SYL 3000, BD 
                <br />
                Email: <a href="mailto:[email protected]" className="underline text-emerald-800"> ticketnenbd@gmail.com </a>
                <br />
                Phone: <a href="Phone:+8801731047260" className="underline text-emerald-800">+8801731047260</a>
              </p>
            </div>
